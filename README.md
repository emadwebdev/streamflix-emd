...
"A full-stack Streamflix built with the MERN stack (MongoDB, Express, React, Node.js), featuring JWT authentication, TMDB API integration for real-time movie data, and a responsive UI inspired by Streamflix’s premium design."
